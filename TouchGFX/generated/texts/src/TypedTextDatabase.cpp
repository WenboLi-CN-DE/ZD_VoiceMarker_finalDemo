...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_consola_20_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_arial_30_4bpp());
        break;
    case 2:
